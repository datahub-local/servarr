...
| oci://tccr.io/truecharts | qbittorrent | 24.2.7 |
| oci://tccr.io/truecharts | radarr | 26.3.6 |
| oci://tccr.io/truecharts | sonarr | 25.2.6 |
...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| global.apikey | string | Autogenerated if not provided | Insert your Prowlarr, Sonarr, Radarr API key here (one to rule them all!). Must be 20 to 32 hexadecimal characters. Do not remove the `&apikey` anchor! |
